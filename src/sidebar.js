        ...
        return (
            <div className="fullsidebar">
                ...
                <div className="tweetBox">
                  ...
                  <h4 className="sentimentDisclaimer">*The sentiment score is calculated using an AFINN-based sentiment analysis (NPM Sentiment v0.2.1) library that creates comparative scores from a scale of -5 (most negative) to 5 (most positive).</h4>
                </div>
            </div>
        </div>
   );
